...
import krd.kurdestan.showen.place.PlaceService;
import krd.kurdestan.showen.user.UserService;
...
public class ImageServiceImpl implements ImageService{
    ...
    public Image getByUserID(Long userId) {
        ...
        if (optionalFileAttachment.isEmpty()) {
            throw new krd.kurdestan.showen.Common.exception.NotFoundException("Not Found");
        }
        return optionalFileAttachment.get();
    }
